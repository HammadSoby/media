...
<style>#wh{color:#aa0000; font-family:"open sans"; font-size:14px; } </style>
 <div id="bookin">
        <span id="book_title">You Are About To Enter Your Information For RADIO Advertising </span></br>
        <span id="book_down">Add your Radio Advertising Information :  </span></br>
        <hr/></br>
        <?php
                if(isset($error)){
                 ?>
