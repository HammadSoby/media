...
$(document).ready(function(){
  ...
  <?php
            ...
            <span id="de">Your Slot Details : </span>&nbsp;&nbsp;
               <style>
            #print{
              color:white;
              font-family: "open sans";
        ...
        <ul>
            ...
            <li><span id="client_info_tit">Descision Maker : </span><?php echo $detail['provider_name']; ?></li>
            ...
            <li><span id="client_info_tit">Media Sizes & Prices : </span><?php echo $detail['price']; ?></li>
            <li><span id="client_info_tit">Slot Added Date :</span> 10/3/2015 </li>
            <li><span id="client_info_tit">Slot Status : </span>
              <?php 
            $leorder_status=$detail['status'];
              if($leorder_status==0){
                echo "Incomplete","<small id='deta'>&nbsp; &nbsp; &nbsp; We havent accepted your details yet. We will contact you.</small>";
              }
              if($leorder_status==1){
                echo "Paid & Pending","<small id='deta'> &nbsp; &nbsp; &nbsp; Your slot details is being processed and will show Accepted once fanilised</small>";
              }
              if($leorder_status==3){
                 echo "Accepted","<small id='deta'>&nbsp; &nbsp; &nbsp;  Your Slot Has Been Validated. Our Clients can now purchase your slot</small>";
              }
            ?></li>
