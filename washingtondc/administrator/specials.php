...
<tr>
    <th bgcolor="#0000FF" colspan="7"><font size="+2" color="#FFFFFF"> <a href="addspecial.php"><font color="#999999">Add 
      New</font></a>&nbsp;Special Offers &nbsp; <a href="mainmenu.php">back...</a></font></th>
</tr>
<tr>
<th>Offer Name</th> <th>Date Created</th> <th>Cost Price</th> <th>Selling Price</th> <th>Live</th> <th>Deadline</th> <th>Select To Edit</th>
</tr>
<?php 
...
{     
	...
	$sSQL = "SELECT SpecialOffers_ID, Live, DateCreated, SpecialOfferCostPrice, SpecialOfferName, SpecialOfferSellingPrice, SpecialOfferDealine FROM SpecialOffers " ;
	//print($sSQL);
	...
	while($thisAccs = mysql_fetch_array($tmpAccs, MYSQL_ASSOC))
	{
		...
		echo("<tr>");
		echo("<td align='center'>" . $SpecialOfferName . "</td>" );
		echo("<td align='center'>" . $DateCreated . "</td>" );
		echo("<td align='center'>&pound;" . $SpecialOfferCostPrice  . "%</td>" );
		echo("<td align='center'>&pound;" . $SpecialOfferSellingPrice . "</td>" );
		echo("<td align='center'>" . $Live . "</td>" );
		echo("<td align='center'>" . $DateCreated . "</td>" );
		echo("<td align='center'><a href = 'special.php?id=" . $SpecialOffers_ID . "'>Select</a></td>" );
		echo("/<tr>");
	}
?> </table> <?	
}		
