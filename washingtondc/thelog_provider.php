...
<div id="form1">
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		$sSQL = "SELECT Providers_ID FROM Providers WHERE ProvidersEmail ='" . $txtEmail . "' and ProvidersPassword ='" . $txtPass . "'" ;
		//print($sSQL);
...
<form method="post" action="" class="form_01">
    ...
    <div id="dha">
        <span id="dtext">
            Don't have an account? <a href="register.php?register=provider">Sign Up </a> Here. </span>
        </div>
</form>
</div>
</div>
