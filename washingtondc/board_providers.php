...
$(document).ready(function(){
  $("#update_but").click(function(){
	...
	<span id="b_title" >Slots Configuration: &nbsp;<a href="viewslot.php">3. View &amp; Add Slots</a> <a href="viewdates.php">2. Set Production Dates</a>  <a href="configureslots.php?pid=<? echo($_SESSION['Provider_ID']); ?>">1. Configure Slot Details</a>   </span>
	<br/>       
	  </div>
	<div id="client_info">
		...
		<hr>
		<a href='javascript:add_file()'>Click to upload Media Kit PDF file</a>
     ...
     <?php
      ...
      <div id="board_content">
        ...
        <ul id="board_data">
      <?php 
	$sSQL = "SELECT DateCreated, Processed, Quantity, SlotName, SlotDescription, SlotCostPrice, SlotQuantity, SlotDeadline FROM SlotOrders, SlotOrdersItems, Slots WHERE SlotOrders.SlotOrders_ID = SlotOrdersItems.SlotOrders_ID And SlotOrdersItems.Slot_ID = Slots.Slot_ID And Slots.Providers_ID =" . $_SESSION['Provider_ID'] ;
	//print($sSQL);
	$tmpAccs = mysql_query($sSQL);
