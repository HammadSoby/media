...
if(isset($_SESSION['logtrue'])){
   ...
   $user_logged=$pdo->prepare("SELECT * FROM users WHERE username=?");
...
$(document).ready(function(){
  ...
  <?php
        ...
        <ul>
            <li><span id="client_info_tit">Order Id : </span><?php echo $detail['id']; ?></li>
            <li><span id="client_info_tit">Order Type : </span><?php echo $detail['type']; ?></li>
            ...
            ?></li>
            <li><span id="client_info_tit">Media Agency : </span> <?php echo $detail['choice']; ?></li>
      
            <li><span id="client_info_tit">Number Of Slot(s) :</span> <?php echo $detail['size'];?> </li>
            <li><span id="client_info_tit">Production Broadcast Date(s) :</span> <?php echo $detail['dates'];?></li>
            <?php 
            if($detail['type']!="Tv Advertising"){
              ?>
              <li><span id="client_info_tit">Size Of Slot :</span> <?php echo $detail['slot'];?></li>
              <?php
            }
            ?>
            <li><span id="client_info_tit">Total Price :</span> £<?php echo $detail['full_price'];?></li>
