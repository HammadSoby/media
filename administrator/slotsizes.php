...
{     
	...
	?>
		<br/> <br/>
	<form action="slotsizes.php?ins=1"	 method="post">
	<table align="center" border="1">
	<tr>
	  <th bgcolor="#0000FF" colspan="5"><font size="+2"><font color="#FFFFFF">Provider 
        Slot Sizes</font></font></th>
	</tr>
	<tr>
		
    <td><font size="+1"> Slot Size:</font></td>
    <td><input type="text" name="txtSlot" /></td>
		...
		<?	
		$sSQL = "SELECT SlotSize_ID, SlotSize FROM SlotSizes Where Providers_ID	 ="  .$pid ;
		//print($sSQL);
