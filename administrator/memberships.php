...
<tr>
  <th bgcolor="#0000FF" colspan="5"><font size="+2" color="#FFFFFF">Memberships &nbsp; <a href="mainmenu.php">back...</a></font></th>
</tr>
<tr>
<th>Membership Name</th> <th>Membership Cost</th> <th>Percentage Offered</th> <th>Description</th> <th>Select To Edit</th>
</tr>
<?php 
...
{     
	...
	$sSQL = "SELECT Membership_ID, MembershipName, Discount, Price, Description FROM Memberships " ;
	//print($sSQL);
	...
	while($thisAccs = mysql_fetch_array($tmpAccs, MYSQL_ASSOC))
	{
		...
		echo("<td align='center'>&pound;" . $Price . "</td>" );
		echo("<td align='center'>" . $Discount  . "%</td>" );
		echo("<td align='center'>" . $Description . "</td>" );
		echo("<td align='center'><a href = 'member.php?id=" . $Membership_ID . "'>Select</a></td>" );
		echo("/<tr>");
	}
?> </table> <?	
}		
