...
<tr>
  <th bgcolor="#0000FF" colspan="5"><font size="+2" color="#FFFFFF">Admin user &nbsp; <a href="mainmenu.php">back...</a></font></th>
</tr>
<tr>
<th>Name</th> <th>Email</th> <th>Password</th> <th>Select To Edit</th>
</tr>
<?php 
...
{     
	...
	$sSQL = "SELECT AdminUser_ID, AdminUserName, AdminUserEmail, AdminUserPassword FROM AdminUsers Order By AdminUserName" ;
	//print($sSQL);
	...
	while($thisAccs = mysql_fetch_array($tmpAccs, MYSQL_ASSOC))
	{
		...
		echo("<tr>");
		echo("<td align='center'>" . $AdminUserName . "</td>" );
		echo("<td align='center'>" . $AdminUserEmail . "</td>" );
		echo("<td align='center'>" . $AdminUserPassword  . "</td>" );
		echo("<td align='center'><a href = 'auser.php?id=" . $AdminUser_ID . "'>Select</a></td>" );
		echo("/<tr>");
	}
?> </table> <?	
}		
