...
<tr>
  <th bgcolor="#0000FF" colspan="5"><font size="+2" color="#FFFFFF">Clients &nbsp; <a href="mainmenu.php">back...</a></font> </th>
</tr>
<tr>
<th>Client Name</th> <th>Company</th> <th>Client Number</th> <th>Membership Name</th> <th>Black Links ID</th>
</tr>
<?php 
...
{     
	...
	$sSQL = "SELECT ClientName, ClientCompany, ClientNumber, BlackLinkID, MembershipName  FROM Clients, Memberships Where Clients.Membership_ID = Memberships.Membership_ID Order By ClientName " ;
	//print($sSQL);
	...
	while($thisAccs = mysql_fetch_array($tmpAccs, MYSQL_ASSOC))
	{
		...
		$ClientNumber = $thisAccs["ClientNumber"];
		...
		echo("<td align='center'>" . $ClientNumber  . "</td>" );
		echo("<td align='center'>" . $MembershipName . "</td>" );
		echo("<td align='center'>" . $BlackLinkID . "</td>" ); 
		echo("/<tr>");
	}
?> </table> <?	
}		
