...
<form method="post" action="" class="form_01">
    ...
    <div id="dha">
        <span id="dtext">
            Don't have an account? <a href="register.php?register=client">Sign Up </a> &nbsp; <a href="clientpassword.php" target="_blank" onClick="window.open('clientpassword.php','name','width=600,height=400')">Password Reminder</a></span>
        </div>
</form>
</div>
</div>
